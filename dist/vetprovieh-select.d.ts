...
export let VetproviehSelect: {
    new (): {
         ...
         */
        _presetInput(searchList: VetproviehList): void;
        /**
         ...
         */
        readonly list: VetproviehList;
        /**
         * Building Search-List
         * @return {VetproviehList}
         * @private
         */
        _buildSearchList(): VetproviehList;
        /**
